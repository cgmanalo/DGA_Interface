...
void loop() {
  ...
  //delay(2000);
  //Serial.println("H2-Transformer1 " + (String) ReadH2A());
  //Serial.println("CH4-Transformer1 " + (String) ReadCH4A());
  //Serial.println("C2H4-Transformer1 " + (String) ReadC2H4A());
  //Serial.println("C2H6-Transformer1 " + (String) ReadC2H6A());
  //Serial.println("H2-Transformer2 " + (String) ReadH2B());
  //Serial.println("CH4-Transformer2 " + (String) ReadCH4B());
  //Serial.println("C2H4-Transformer2 " + (String) ReadC2H4B());
  //Serial.println("C2H6-Transformer2 " + (String) ReadC2H6B());
  //delay(2000);
  ...
  if (CommandField == "H2A"){
    SR("H2A|" + (String) ReadH2A());
  }
  if (CommandField == "CH4A"){
    SR("CH4A|" + (String) ReadCH4A());
  }
...
//*****TRANSFORMER 1*****//
float ReadH2A(){
  PORTD = PORTD & B11000111; //set multiplexer to read H2A
  delay(100);
  return 1000.0*(analogRead(A0)/1023.0);
}

float ReadCH4A(){
  PORTD = (PORTD & B11001111)|B00001000; //set multiplexer to read CH4A
  delay(100);
  return 80.0*(analogRead(A0)/1023.0);
}

float ReadC2H4A(){
  PORTD = (PORTD & B11010111)|B00010000; //set multiplexer to read CH4A
  delay(100);
  return 100.0*(analogRead(A0)/1023.0);
}

float ReadC2H6A(){
  PORTD = (PORTD & B11011111)|B00011000; //set multiplexer to read CH4A
  delay(100);
...
//*****TRANSFORMER 2*****//
float ReadH2B(){
  PORTD = PORTD & B11000111; //set multiplexer to read H2B
  delay(100);
  return 1000.0*(analogRead(A1)/1023.0);
}

float ReadCH4B(){
  PORTD = (PORTD & B11001111)|B00001000; //set multiplexer to read CH4B
  delay(100);
  return 80.0*(analogRead(A1)/1023.0);
}

float ReadC2H4B(){
  PORTD = (PORTD & B11010111)|B00010000; //set multiplexer to read CH4B
  delay(100);
  return 100.0*(analogRead(A1)/1023.0);
}

float ReadC2H6B(){
  PORTD = (PORTD & B11011111)|B00011000; //set multiplexer to read CH4B
  delay(100);
